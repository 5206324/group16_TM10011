...
#%% Pip install nodig voor stap 1
# pip install dask distributed scikit-learn-intelex
# pip install pandas numpy matplotlib seaborn scikit-learn dask distributed statsmodels